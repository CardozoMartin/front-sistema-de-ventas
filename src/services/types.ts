...
export interface Product {
  ...
  active: boolean;
  status: 'activo' | 'incompleto' | 'pendiente_revision' | 'sin_movimiento' | 'oculto' | 'archivado';
...
/**
 * Conteo de denominaciones de billetes/monedas
 */
...
/**
 * Datos para crear un movimiento de caja
 */
...
/**
 * Interfaz para el modelo de Cliente real
 */
export interface Client {
  ...
  phone?: string;
  email?: string;
  debt: number; // Deuda acumulada
  maxCredit?: number; // Límite de crédito opcional
  active: boolean;
  createdAt: string;
  updatedAt: string;
}
