  ...
  const handleDelete = (promotion: Promotion) => {
    Swal.fire({
      ...
      customClass: {
        ...swalCustomClass,
        confirmButton:
          "px-4 py-2 bg-red-700 text-white rounded-md text-sm font-medium hover:bg-red-800 transition-colors mr-2",
      },
              ...
              <td className="px-4 py-3 text-center">
                <div className="flex items-center justify-center gap-1">
                  <button
                    ...
                    className="p-1.5 text-neutral-800 hover:bg-blue-50 rounded transition"
                    title="Ver detalles"
                  >
